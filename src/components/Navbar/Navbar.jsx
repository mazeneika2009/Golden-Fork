      ...
      <div className="navbar-container">
        ...
        <div className={`nav-menu ${isMenuOpen ? 'active' : ''}`}>
          <ul className="nav-links">
            <li><a href="#menu" onClick={(e) => { e.preventDefault(); scrollToSection('menu'); }}>{t('nav.menu')}</a></li>
            <li><a href="#story" onClick={(e) => { e.preventDefault(); scrollToSection('story'); }}>{t('nav.story')}</a></li>
          ...
          <button className="cart-btn" type="button" aria-label={t('nav.cart')} onClick={handleCartClick}>
